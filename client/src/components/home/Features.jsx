...
const Features = () => {
  ...
  return (
    <div id="features" className="flex flex-col items-center my-10 scroll-mt-12">
      <div className="flex justify-center items-center gap-2 text-sm text-indigo-800 bg-indigo-400/10  rounded-full px-4 py-1">
       <Zap width={14}/>
        <span>Simple Process</span>
      </div>
      <Title title='Build your Resume' description='Turn your achievements into a compelling professional story. Build modern, job-winning resumes with intelligent AI assistance, beautiful templates, and personalized content designed to help you make a lasting first impression.'/>
